...
public extension URLRouterType {
    ...
    @discardableResult
    func openRoute(_ routeConvertible: URLRouteConvertible, parameters: [String: Any] = [:], completion: @escaping (Any?) -> Void) -> Bool {
        openRoute(routeConvertible.routeString, parameters: parameters, completion: completion)
    }
