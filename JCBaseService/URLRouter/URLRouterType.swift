...
public typealias HandleRouteFactory = (_ routeUrl: RouteURL, _ navigator: NavigatorType, _ completion: Completion) -> Bool
...
@objc public protocol URLRouterType: NSObjectProtocol {
    ...
    /// - Returns: Bool
    func openRoute(_ route: URLRouteName, parameters: [String: Any], completion: Completion) -> Bool
}
...
extension URLRouterType {
    ...
    public func openRoute(_ route: URLRouteName, parameters: [String: Any] = [:], completion: Completion) -> Bool {
        openRoute(route, parameters: parameters, completion: completion)
    }
}
